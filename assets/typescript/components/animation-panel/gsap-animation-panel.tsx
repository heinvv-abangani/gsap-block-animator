 ...
 */
function GSAPAnimationPanel({ attributes, setAttributes }: GSAPAnimationPanelProps): any {
     ...
     */
    const updateProperty = (key: string, value: any): void => {
     ...
     */
    const updateTiming = (key: keyof AnimationConfig['timing'], value: any): void => {
        updateAnimation({
     ...
     */
    const updateTimeline = (key: keyof TimelineConfig, value: any): void => {
        updateAnimation({
            timeline: { 
    ...
    const renderControls = (): any[] => {
        ...
        if (gsapAnimation.enabled) {
            ...
            if (!gsapAnimation.timeline?.isTimeline) {
                ...
                if (gsapAnimation.timeline?.timelinePosition === 'custom') {
                    controls.push(
                        createElement(TextControl, {
                            key: 'custom-position',
