...
import type { EaseType } from '../../../types/animation';
...
export class TimingControlsSection {
	...
	private static renderDurationControl(timing: any, updateTiming: (key: string, value: unknown) => void): JSX.Element {
		return (
			<RangeControl
	...
	private static renderDelayControl(timing: any, updateTiming: (key: string, value: unknown) => void): JSX.Element {
		return (
			<RangeControl
	...
	private static renderRepeatControl(timing: any, updateTiming: (key: string, value: unknown) => void): JSX.Element {
		return (
			<RangeControl
	...
	private static renderYoyoControl(timing: any, updateTiming: (key: string, value: unknown) => void): JSX.Element {
		return (
			<ToggleControl
	...
	private static renderEaseControl(timing: any, updateTiming: (key: string, value: unknown) => void): JSX.Element {
		return (
			<SelectControl
