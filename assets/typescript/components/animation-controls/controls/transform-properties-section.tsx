...
export class TransformPropertiesSection {
	...
	private static renderMovementControls(properties: Record<string, any>, updateProperty: (key: string, value: unknown) => void): JSX.Element {
		return (
			<Fragment>
				<TextControl
	...
	private static renderTransformControls(properties: Record<string, any>, updateProperty: (key: string, value: unknown) => void): JSX.Element {
		return (
			<Fragment>
				<TextControl
	...
	private static renderOpacityControl(properties: Record<string, any>, updateProperty: (key: string, value: unknown) => void): JSX.Element {
		return (
			<RangeControl
	...
	private static renderColorControl(properties: Record<string, any>, updateProperty: (key: string, value: unknown) => void): JSX.Element {
		return (
			<TextControl
