...
class Property_Validator {
	...
	public static function sanitize_numeric_value( $value, float $min, float $max, float $fallback_value = 0 ): float {
		if ( ! is_numeric( $value ) ) {
	...
	public static function sanitize_css_color( string $value, string $fallback_color = 'transparent' ): string {
