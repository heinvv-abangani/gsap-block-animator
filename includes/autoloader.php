...
class Autoloader {
	...
	private static function init_classes_map(): void {
		self::$classes_map = [
			...
			'Container\ContainerInterface' => 'container/ContainerInterface.php',
			'Container\ServiceProviderInterface' => 'container/ServiceProviderInterface.php',
			'Container\ContainerException' => 'container/ContainerException.php',
			'Services\ServiceProvider' => 'services/ServiceProvider.php',
			'Services\AnimationService' => 'services/AnimationService.php',
			'Services\BlockExtensionService' => 'services/BlockExtensionService.php',
