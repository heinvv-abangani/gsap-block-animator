...
class To_Animation_Strategy implements Animation_Strategy_Interface {
	...
	public function validate_config( Animation_Config $config ): array {
		...
		if ( empty( $config->get_properties() ) ) {
			$errors[] = 'To animation requires at least one property to animate';
		}
